...
int Stopwatch::linear_stopwatch(const std::vector<Book> &nb, const std::vector<Book> &r) {
...
int Stopwatch::binary_stopwatch(std::vector<Book> &nb, const std::vector<Book> &r){
    auto start = std::chrono::high_resolution_clock::now();
